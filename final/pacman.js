...
class Pacman {
  ...
  birth() {
    ...
    if (r < 0.001) {
      ...
      return new Pacman(this.position.x, this.position.y, this.dna);
    }
  }
  ...
  display() {
    ...
    textSize(16);
    text(int(this.health*10), 0, 0);
    pop();
    textSize(10);
    fill(255);
    if (int(this.health*10)>20 && 28>int(this.health*10)){
      text("yay", this.position.x+12, this.position.y+12);
    } else if (int(this.health*10)<6){
      text("...", this.position.x+12, this.position.y+12);
    }
  }
